import{c as z,r as G,j as e,H as I}from"./app-DTTdiUTJ.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-g_LXmIWi.js";import{B as Y}from"./button-5J2EJa-S.js";import{G as D}from"./GurukulReportCard-C8513CMV.js";import{A as J}from"./award-DRiGjmlE.js";import{F as K}from"./file-text-nOSwPj-2.js";import{P as V}from"./printer-BvMBgImT.js";import"./app-D4qtUzod.js";import"./breadcrumb-YoveKBhn.js";import"./chevron-right-Z-X3SlAO.js";import"./index-wj4iBPOe.js";import"./loader-circle-Lxw0kv7k.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
