import{c as z,r as G,j as e,H as I}from"./app-BZl-7ex2.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-ClYekXnt.js";import{B as Y}from"./button-BJNI65VA.js";import{G as D}from"./GurukulReportCard-DxICECMG.js";import{A as J}from"./award-CNRiFBc-.js";import{F as K}from"./file-text-0ds7br1N.js";import{P as V}from"./printer-_WDYmrZC.js";import"./app-DyCJ9so6.js";import"./breadcrumb-5qPxJb3q.js";import"./chevron-right-CDeS_ByN.js";import"./index-B-EsgjT5.js";import"./loader-circle-CTCM0qWl.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
