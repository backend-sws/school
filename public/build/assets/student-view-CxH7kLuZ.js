import{c as H,r as M,j as e,H as P}from"./app-DoTjjpXi.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-DcurjLcZ.js";import{B as U}from"./button-Bhi6TiUz.js";import{G as $}from"./GurukulReportCard-CSfngl6f.js";import{A as z}from"./award-Dboc_gxD.js";import{F as G}from"./file-text-la1zR6_o.js";import{P as D}from"./printer-Rc2_rVM-.js";import"./app-BCu_pOsk.js";import"./breadcrumb-wiwX5RAx.js";import"./chevron-right-BRko06bP.js";import"./index-CbLVoB_D.js";import"./loader-circle-Bb9576tn.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
