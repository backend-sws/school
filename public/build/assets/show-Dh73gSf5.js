import{c as z,r as G,j as e,H as I}from"./app-DaHAONht.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CDb3s0Aw.js";import{B as Y}from"./button-DjrPKddl.js";import{G as D}from"./GurukulReportCard-BFetW5nz.js";import{A as J}from"./award-D_1uG55H.js";import{F as K}from"./file-text-CtfCd_zY.js";import{P as V}from"./printer-CWy0y7hY.js";import"./app-DV3szMhS.js";import"./breadcrumb-DLmblJBs.js";import"./chevron-right-Brdzt0vK.js";import"./index--SNtmG1r.js";import"./loader-circle-DNmAR9OA.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
