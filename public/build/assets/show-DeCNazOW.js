import{c as z,r as G,j as e,H as I}from"./app-Cm9FiIg0.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CUsfUFJM.js";import{B as Y}from"./button-C6QGnt3G.js";import{G as D}from"./GurukulReportCard-DRhjf0Tq.js";import{A as J}from"./award-CjElX89Z.js";import{F as K}from"./file-text-DTMgLlU0.js";import{P as V}from"./printer-uIPGuaAT.js";import"./app-CO_KHxlD.js";import"./breadcrumb-Ds96zVwd.js";import"./chevron-right-DdJso_Pz.js";import"./index-B7CFk2_I.js";import"./loader-circle-2bQtiltD.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
