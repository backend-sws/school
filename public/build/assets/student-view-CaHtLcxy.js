import{c as H,r as M,j as e,H as P}from"./app-C_L6r7HP.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-D4sWwCW6.js";import{B as U}from"./button-CL1MCeZP.js";import{G as $}from"./GurukulReportCard-BQLHibvx.js";import{A as z}from"./award-BqOvbRN8.js";import{F as G}from"./file-text-BxxXy3FM.js";import{P as D}from"./printer-DI3iORk0.js";import"./app-B7qWJiIz.js";import"./breadcrumb-CFKxRqVB.js";import"./chevron-right-DuKGZiPB.js";import"./index-DpAtkLLp.js";import"./loader-circle-C3SVMQCu.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
