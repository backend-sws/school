import{c as H,r as M,j as e,H as P}from"./app-CRSHjZ7W.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-D6mc5FSL.js";import{B as U}from"./button-DkcTjtIV.js";import{G as $}from"./GurukulReportCard-7u04kgnN.js";import{A as z}from"./award-CZrfsO-H.js";import{F as G}from"./file-text-tOyOXMHG.js";import{P as D}from"./printer-Cdp5aO7f.js";import"./app-Dc1OEn8E.js";import"./breadcrumb-CyVDPYJB.js";import"./chevron-right-DMUsWyo2.js";import"./index-D3RF2tsV.js";import"./loader-circle-C6qaERjE.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
