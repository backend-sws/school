import{c as H,r as M,j as e,H as P}from"./app-n07DLmIU.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-C6-Eqzl8.js";import{B as U}from"./button-C9gOo6eD.js";import{G as $}from"./GurukulReportCard-CfY1mt5G.js";import{A as z}from"./award-DFCySM3k.js";import{F as G}from"./file-text-BDo0Cdcp.js";import{P as D}from"./printer-Be7FdwSu.js";import"./app-CcLIgfOg.js";import"./breadcrumb-y86m4zOw.js";import"./chevron-right-B-WFYF2b.js";import"./index-DTvtEbHQ.js";import"./loader-circle-Djc-f0_l.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
