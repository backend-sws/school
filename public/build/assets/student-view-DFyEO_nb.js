import{c as H,r as M,j as e,H as P}from"./app-CokvSuEj.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-DkqXEdWR.js";import{B as U}from"./button-0DVph7kS.js";import{G as $}from"./GurukulReportCard-B0y07F68.js";import{A as z}from"./award-BbLGy8cQ.js";import{F as G}from"./file-text-C96WkjfF.js";import{P as D}from"./printer-DcDmnpkW.js";import"./app-BRQ15RFd.js";import"./breadcrumb-Bh8iTOU_.js";import"./chevron-right-BedpljNc.js";import"./index-BlWpE7gv.js";import"./loader-circle-DSD5wfAa.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
