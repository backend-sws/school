import{c as H,r as M,j as e,H as P}from"./app-6piELyaF.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-pkBBUjCW.js";import{B as U}from"./button-CZrB2U37.js";import{G as $}from"./GurukulReportCard-1mIdxO7F.js";import{A as z}from"./award-3CQr8HgC.js";import{F as G}from"./file-text-C9zGkz5k.js";import{P as D}from"./printer-DYvtXlxD.js";import"./app-Ddo-U8U-.js";import"./breadcrumb-DXG0zT91.js";import"./chevron-right-C2NccCO3.js";import"./index-CnjAUX91.js";import"./loader-circle-DJhcUJvy.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
