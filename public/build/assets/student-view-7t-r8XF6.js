import{c as H,r as M,j as e,H as P}from"./app-Cm9FiIg0.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CUsfUFJM.js";import{B as U}from"./button-C6QGnt3G.js";import{G as $}from"./GurukulReportCard-DRhjf0Tq.js";import{A as z}from"./award-CjElX89Z.js";import{F as G}from"./file-text-DTMgLlU0.js";import{P as D}from"./printer-uIPGuaAT.js";import"./app-CO_KHxlD.js";import"./breadcrumb-Ds96zVwd.js";import"./chevron-right-DdJso_Pz.js";import"./index-B7CFk2_I.js";import"./loader-circle-2bQtiltD.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
