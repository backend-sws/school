import{c as z,r as G,j as e,H as I}from"./app-6piELyaF.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-pkBBUjCW.js";import{B as Y}from"./button-CZrB2U37.js";import{G as D}from"./GurukulReportCard-1mIdxO7F.js";import{A as J}from"./award-3CQr8HgC.js";import{F as K}from"./file-text-C9zGkz5k.js";import{P as V}from"./printer-DYvtXlxD.js";import"./app-Ddo-U8U-.js";import"./breadcrumb-DXG0zT91.js";import"./chevron-right-C2NccCO3.js";import"./index-CnjAUX91.js";import"./loader-circle-DJhcUJvy.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
