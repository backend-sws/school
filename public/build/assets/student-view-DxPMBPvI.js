import{c as H,r as M,j as e,H as P}from"./app-CXYvnntf.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-DygUTfsl.js";import{B as U}from"./button-DhvR8igz.js";import{G as $}from"./GurukulReportCard-DqbZfsjO.js";import{A as z}from"./award-CDJ9D1Lu.js";import{F as G}from"./file-text-BoY6edAJ.js";import{P as D}from"./printer-aBzvbe-m.js";import"./app-DOm6CmO2.js";import"./breadcrumb-CED52nP7.js";import"./chevron-right-DBmNINFb.js";import"./index-BHsNJQ66.js";import"./loader-circle-DXkvEJHm.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
