import{c as z,r as G,j as e,H as I}from"./app-KPX6nfzE.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-6FbgrvXW.js";import{B as Y}from"./button-CvQCyro8.js";import{G as D}from"./GurukulReportCard-CINvIPrA.js";import{A as J}from"./award-2jcvekOI.js";import{F as K}from"./file-text-BR2dkFKF.js";import{P as V}from"./printer-CDKDABBt.js";import"./app-B4v9i1E2.js";import"./breadcrumb-CZgKHMkr.js";import"./chevron-right-DhsPKe6g.js";import"./index-DXjqCH69.js";import"./loader-circle-Cf3NWFVY.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
