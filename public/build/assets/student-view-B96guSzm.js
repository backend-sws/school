import{c as H,r as M,j as e,H as P}from"./app-DDDDiCjt.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CZ530Z_k.js";import{B as U}from"./button-DpYpwPiw.js";import{G as $}from"./GurukulReportCard-ChaY1aCZ.js";import{A as z}from"./award-CbVoSWs3.js";import{F as G}from"./file-text-8U9BXD-A.js";import{P as D}from"./printer-C_xYkLPf.js";import"./app-C9qIsdr5.js";import"./breadcrumb-B_K61oJX.js";import"./chevron-right-CQSS2hQ6.js";import"./index-B96u0kLA.js";import"./loader-circle-Bk0T7vmt.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
