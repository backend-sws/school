import{c as H,r as M,j as e,H as P}from"./app-DTTdiUTJ.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-g_LXmIWi.js";import{B as U}from"./button-5J2EJa-S.js";import{G as $}from"./GurukulReportCard-C8513CMV.js";import{A as z}from"./award-DRiGjmlE.js";import{F as G}from"./file-text-nOSwPj-2.js";import{P as D}from"./printer-BvMBgImT.js";import"./app-D4qtUzod.js";import"./breadcrumb-YoveKBhn.js";import"./chevron-right-Z-X3SlAO.js";import"./index-wj4iBPOe.js";import"./loader-circle-Lxw0kv7k.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
