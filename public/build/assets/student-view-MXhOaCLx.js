import{c as H,r as M,j as e,H as P}from"./app-CLguWLaP.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-DpQE8ZWK.js";import{B as U}from"./button-DLDdTFLB.js";import{G as $}from"./GurukulReportCard-CZ92c92p.js";import{A as z}from"./award-v6tguNNg.js";import{F as G}from"./file-text-9nMiSZSg.js";import{P as D}from"./printer-DbCmq-y0.js";import"./app-NVNK7V72.js";import"./breadcrumb-RNoDy9W_.js";import"./chevron-right-DV39Ykhz.js";import"./index-BFjHvNcj.js";import"./loader-circle-C3OG-myO.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
