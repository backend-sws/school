import{c as H,r as M,j as e,H as P}from"./app-DaHAONht.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CDb3s0Aw.js";import{B as U}from"./button-DjrPKddl.js";import{G as $}from"./GurukulReportCard-BFetW5nz.js";import{A as z}from"./award-D_1uG55H.js";import{F as G}from"./file-text-CtfCd_zY.js";import{P as D}from"./printer-CWy0y7hY.js";import"./app-DV3szMhS.js";import"./breadcrumb-DLmblJBs.js";import"./chevron-right-Brdzt0vK.js";import"./index--SNtmG1r.js";import"./loader-circle-DNmAR9OA.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
