import{c as z,r as G,j as e,H as I}from"./app-DoTjjpXi.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-DcurjLcZ.js";import{B as Y}from"./button-Bhi6TiUz.js";import{G as D}from"./GurukulReportCard-CSfngl6f.js";import{A as J}from"./award-Dboc_gxD.js";import{F as K}from"./file-text-la1zR6_o.js";import{P as V}from"./printer-Rc2_rVM-.js";import"./app-BCu_pOsk.js";import"./breadcrumb-wiwX5RAx.js";import"./chevron-right-BRko06bP.js";import"./index-CbLVoB_D.js";import"./loader-circle-Bb9576tn.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
