import{c as H,r as M,j as e,H as P}from"./app-CpL1Q3Bt.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-BT34c9lw.js";import{B as U}from"./button-BEw1Lqpd.js";import{G as $}from"./GurukulReportCard-_eWbFwiL.js";import{A as z}from"./award-DKtBV-DD.js";import{F as G}from"./file-text-C-oo1RRR.js";import{P as D}from"./printer-DFYYCBm6.js";import"./app-B7qWJiIz.js";import"./breadcrumb-BMN7QcYN.js";import"./chevron-right-O6tSaIv-.js";import"./index-mZBLvyX9.js";import"./loader-circle-DAanHVAW.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
