import{c as H,r as M,j as e,H as P}from"./app-Dr10gogY.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-BQXHgGZ3.js";import{B as U}from"./button-BXLHx4eo.js";import{G as $}from"./GurukulReportCard-0dE6yyK4.js";import{A as z}from"./award-DFM0RXHD.js";import{F as G}from"./file-text-INHOfvPd.js";import{P as D}from"./printer-ITjE-q2k.js";import"./app-x2TehP3I.js";import"./breadcrumb-CD4GTIUu.js";import"./chevron-right-i3CZRubN.js";import"./index-DK0urmkx.js";import"./loader-circle-BM5x56i7.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
