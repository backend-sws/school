import{c as z,r as G,j as e,H as I}from"./app-CpL1Q3Bt.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-BT34c9lw.js";import{B as Y}from"./button-BEw1Lqpd.js";import{G as D}from"./GurukulReportCard-_eWbFwiL.js";import{A as J}from"./award-DKtBV-DD.js";import{F as K}from"./file-text-C-oo1RRR.js";import{P as V}from"./printer-DFYYCBm6.js";import"./app-B7qWJiIz.js";import"./breadcrumb-BMN7QcYN.js";import"./chevron-right-O6tSaIv-.js";import"./index-mZBLvyX9.js";import"./loader-circle-DAanHVAW.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
