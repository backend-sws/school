import{c as H,r as M,j as e,H as P}from"./app-D6CsOpkj.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-B2i2no5x.js";import{B as U}from"./button-Dj_gNFmV.js";import{G as $}from"./GurukulReportCard-C-ze5nAv.js";import{A as z}from"./award-Be6boFOl.js";import{F as G}from"./file-text-LfHCJaSX.js";import{P as D}from"./printer-CfbWOM2f.js";import"./app-la6zERMq.js";import"./breadcrumb-CwfW_qtx.js";import"./chevron-right-DyvQUIIU.js";import"./index-Cwmmw4ml.js";import"./loader-circle-Cjm-n_I9.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
