import{c as z,r as G,j as e,H as I}from"./app-Dr10gogY.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-BQXHgGZ3.js";import{B as Y}from"./button-BXLHx4eo.js";import{G as D}from"./GurukulReportCard-0dE6yyK4.js";import{A as J}from"./award-DFM0RXHD.js";import{F as K}from"./file-text-INHOfvPd.js";import{P as V}from"./printer-ITjE-q2k.js";import"./app-x2TehP3I.js";import"./breadcrumb-CD4GTIUu.js";import"./chevron-right-i3CZRubN.js";import"./index-DK0urmkx.js";import"./loader-circle-BM5x56i7.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
