import{c as z,r as G,j as e,H as I}from"./app-BxzC931K.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CYcFatei.js";import{B as Y}from"./button-DxsnLafN.js";import{G as D}from"./GurukulReportCard-ih2WxBf_.js";import{A as J}from"./award-Dk3Zg_xb.js";import{F as K}from"./file-text-kNV3XFWx.js";import{P as V}from"./printer-BeiCA7PM.js";import"./app-wncjKynN.js";import"./breadcrumb-RnrzztxQ.js";import"./chevron-right-NhSSKyUN.js";import"./index-B5ubXrMR.js";import"./loader-circle-DnH31e7A.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
