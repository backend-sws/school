import{c as z,r as G,j as e,H as I}from"./app-C18Sz5h1.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-BNJ1JXDF.js";import{B as Y}from"./button-BqScBw3n.js";import{G as D}from"./GurukulReportCard-MS2Tz1xX.js";import{A as J}from"./award-FXzU9l6R.js";import{F as K}from"./file-text-CYMom-vp.js";import{P as V}from"./printer-CHKSiyrM.js";import"./app-CY4rgINh.js";import"./breadcrumb-MwovxL_K.js";import"./chevron-right-VcDRKGh8.js";import"./index-pBRwZQGN.js";import"./loader-circle-BHDq2MCu.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
