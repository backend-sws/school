import{c as H,r as M,j as e,H as P}from"./app-Cwd1Fsrc.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CAO83-Dr.js";import{B as U}from"./button-Qm3faOKg.js";import{G as $}from"./GurukulReportCard-k5ucpwM8.js";import{A as z}from"./award-DInhCWKz.js";import{F as G}from"./file-text-_c7S_KAS.js";import{P as D}from"./printer-Ck972nBi.js";import"./app-7jwgCYCy.js";import"./breadcrumb-B8oA9zZT.js";import"./chevron-right-nAtVOCOh.js";import"./index-BK2byX5B.js";import"./loader-circle-BHtveSOj.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
