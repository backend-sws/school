import{c as H,r as M,j as e,H as P}from"./app-BJ09nUjR.js";import{S as F}from"./breadcrumbs-CxqP3Ty0.js";import{M as B}from"./MainPageHeader-DtaOXN-z.js";import{B as U}from"./button-BdS_B1Cd.js";import{G as $}from"./GurukulReportCard-CCNWxSpJ.js";import{A as z}from"./award-BbgXeAck.js";import{F as G}from"./file-text-Dsek6dt3.js";import{P as D}from"./printer-g6gjGARd.js";import"./app-BAHbSmPN.js";import"./breadcrumb-JMXnLZY3.js";import"./chevron-right-CDYRmvcA.js";import"./index-MGwb6nJx.js";import"./loader-circle-BWl_Wk0A.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
