import{c as H,r as M,j as e,H as P}from"./app-kBj0ul1V.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CMJelBoO.js";import{B as U}from"./button-D-DzAwGP.js";import{G as $}from"./GurukulReportCard-Bki9xMRa.js";import{A as z}from"./award-V6NkBU2y.js";import{F as G}from"./file-text-DYpZ6yLt.js";import{P as D}from"./printer-BQcMAhty.js";import"./app-Cshy28NO.js";import"./breadcrumb-B46qB36S.js";import"./chevron-right-DluGBAGi.js";import"./index-uOcz-REP.js";import"./loader-circle-CZPiUHiN.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
