import{c as H,r as M,j as e,H as P}from"./app-CGiPAJMl.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-6yCOAzYO.js";import{B as U}from"./button-DukRv4Mz.js";import{G as $}from"./GurukulReportCard-DvDINP48.js";import{A as z}from"./award-Bw_TFLx8.js";import{F as G}from"./file-text-CL_kiddd.js";import{P as D}from"./printer-XI4HNsbA.js";import"./app-CcLIgfOg.js";import"./breadcrumb-BOEW8AWY.js";import"./chevron-right-BBRqNXZL.js";import"./index-aORX_zsu.js";import"./loader-circle-8tXLYFRj.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
