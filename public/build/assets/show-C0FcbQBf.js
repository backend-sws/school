import{c as z,r as G,j as e,H as I}from"./app-Ccr8P44O.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-2oZkkWmw.js";import{B as Y}from"./button-Bw1Xy9dz.js";import{G as D}from"./GurukulReportCard-B36oAx1B.js";import{A as J}from"./award-CGFXcboK.js";import{F as K}from"./file-text-nww2w09D.js";import{P as V}from"./printer-BkPRsld1.js";import"./app-B8MoKkf6.js";import"./breadcrumb-CiU6JB3v.js";import"./chevron-right-DRBSusEP.js";import"./index-BwNzEkz4.js";import"./loader-circle-B4v2CFLt.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
