import{c as H,r as M,j as e,H as P}from"./app-KPX6nfzE.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-6FbgrvXW.js";import{B as U}from"./button-CvQCyro8.js";import{G as $}from"./GurukulReportCard-CINvIPrA.js";import{A as z}from"./award-2jcvekOI.js";import{F as G}from"./file-text-BR2dkFKF.js";import{P as D}from"./printer-CDKDABBt.js";import"./app-B4v9i1E2.js";import"./breadcrumb-CZgKHMkr.js";import"./chevron-right-DhsPKe6g.js";import"./index-DXjqCH69.js";import"./loader-circle-Cf3NWFVY.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
