import{c as z,r as G,j as e,H as I}from"./app-Cwd1Fsrc.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CAO83-Dr.js";import{B as Y}from"./button-Qm3faOKg.js";import{G as D}from"./GurukulReportCard-k5ucpwM8.js";import{A as J}from"./award-DInhCWKz.js";import{F as K}from"./file-text-_c7S_KAS.js";import{P as V}from"./printer-Ck972nBi.js";import"./app-7jwgCYCy.js";import"./breadcrumb-B8oA9zZT.js";import"./chevron-right-nAtVOCOh.js";import"./index-BK2byX5B.js";import"./loader-circle-BHtveSOj.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
