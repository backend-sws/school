import{c as H,r as M,j as e,H as P}from"./app-DgiipGtx.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CiJmSasF.js";import{B as U}from"./button-DNVHAj2w.js";import{G as $}from"./GurukulReportCard-DMKJMcY_.js";import{A as z}from"./award-B-Coqbjd.js";import{F as G}from"./file-text-CTLEI8EQ.js";import{P as D}from"./printer-DafEpQ5M.js";import"./app-DV3szMhS.js";import"./breadcrumb-C4aDidBN.js";import"./chevron-right-DgtX9cLG.js";import"./index-DiZNzVMa.js";import"./loader-circle-DBLm4OjR.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
