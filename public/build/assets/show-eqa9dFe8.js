import{c as z,r as G,j as e,H as I}from"./app-DDDDiCjt.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CZ530Z_k.js";import{B as Y}from"./button-DpYpwPiw.js";import{G as D}from"./GurukulReportCard-ChaY1aCZ.js";import{A as J}from"./award-CbVoSWs3.js";import{F as K}from"./file-text-8U9BXD-A.js";import{P as V}from"./printer-C_xYkLPf.js";import"./app-C9qIsdr5.js";import"./breadcrumb-B_K61oJX.js";import"./chevron-right-CQSS2hQ6.js";import"./index-B96u0kLA.js";import"./loader-circle-Bk0T7vmt.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
