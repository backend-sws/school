import{c as z,r as G,j as e,H as I}from"./app-D6CsOpkj.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-B2i2no5x.js";import{B as Y}from"./button-Dj_gNFmV.js";import{G as D}from"./GurukulReportCard-C-ze5nAv.js";import{A as J}from"./award-Be6boFOl.js";import{F as K}from"./file-text-LfHCJaSX.js";import{P as V}from"./printer-CfbWOM2f.js";import"./app-la6zERMq.js";import"./breadcrumb-CwfW_qtx.js";import"./chevron-right-DyvQUIIU.js";import"./index-Cwmmw4ml.js";import"./loader-circle-Cjm-n_I9.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
