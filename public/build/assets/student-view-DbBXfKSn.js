import{c as H,r as M,j as e,H as P}from"./app-BxzC931K.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-CYcFatei.js";import{B as U}from"./button-DxsnLafN.js";import{G as $}from"./GurukulReportCard-ih2WxBf_.js";import{A as z}from"./award-Dk3Zg_xb.js";import{F as G}from"./file-text-kNV3XFWx.js";import{P as D}from"./printer-BeiCA7PM.js";import"./app-wncjKynN.js";import"./breadcrumb-RnrzztxQ.js";import"./chevron-right-NhSSKyUN.js";import"./index-B5ubXrMR.js";import"./loader-circle-DnH31e7A.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
