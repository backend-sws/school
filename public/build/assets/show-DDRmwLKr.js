import{c as z,r as G,j as e,H as I}from"./app-DgiipGtx.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CiJmSasF.js";import{B as Y}from"./button-DNVHAj2w.js";import{G as D}from"./GurukulReportCard-DMKJMcY_.js";import{A as J}from"./award-B-Coqbjd.js";import{F as K}from"./file-text-CTLEI8EQ.js";import{P as V}from"./printer-DafEpQ5M.js";import"./app-DV3szMhS.js";import"./breadcrumb-C4aDidBN.js";import"./chevron-right-DgtX9cLG.js";import"./index-DiZNzVMa.js";import"./loader-circle-DBLm4OjR.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
