import{c as z,r as G,j as e,H as I}from"./app-CGiPAJMl.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-6yCOAzYO.js";import{B as Y}from"./button-DukRv4Mz.js";import{G as D}from"./GurukulReportCard-DvDINP48.js";import{A as J}from"./award-Bw_TFLx8.js";import{F as K}from"./file-text-CL_kiddd.js";import{P as V}from"./printer-XI4HNsbA.js";import"./app-CcLIgfOg.js";import"./breadcrumb-BOEW8AWY.js";import"./chevron-right-BBRqNXZL.js";import"./index-aORX_zsu.js";import"./loader-circle-8tXLYFRj.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
