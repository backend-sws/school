import{c as H,r as M,j as e,H as P}from"./app-DjcrZXpY.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-DW2VfvVz.js";import{B as U}from"./button-Vbm9mg42.js";import{G as $}from"./GurukulReportCard-DT26GvFf.js";import{A as z}from"./award-DlbUVo9R.js";import{F as G}from"./file-text-CNLk7pGI.js";import{P as D}from"./printer-BFO13CQL.js";import"./app-BDvIfzgH.js";import"./breadcrumb-BljlVKFY.js";import"./chevron-right-CcVCJnIO.js";import"./index-CnjWvy8Q.js";import"./loader-circle-BsMGkwA6.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
