import{c as z,r as G,j as e,H as I}from"./app-n07DLmIU.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-C6-Eqzl8.js";import{B as Y}from"./button-C9gOo6eD.js";import{G as D}from"./GurukulReportCard-CfY1mt5G.js";import{A as J}from"./award-DFCySM3k.js";import{F as K}from"./file-text-BDo0Cdcp.js";import{P as V}from"./printer-Be7FdwSu.js";import"./app-CcLIgfOg.js";import"./breadcrumb-y86m4zOw.js";import"./chevron-right-B-WFYF2b.js";import"./index-DTvtEbHQ.js";import"./loader-circle-Djc-f0_l.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
