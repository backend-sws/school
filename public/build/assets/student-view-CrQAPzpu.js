import{c as H,r as M,j as e,H as P}from"./app-DtuTNg46.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-C8CIb4JZ.js";import{B as U}from"./button-hgZy4EM2.js";import{G as $}from"./GurukulReportCard-DQD0n1TR.js";import{A as z}from"./award-zeRcDsom.js";import{F as G}from"./file-text-BmqxKUWD.js";import{P as D}from"./printer-DPSP_gN3.js";import"./app-CPasfBTR.js";import"./breadcrumb-CY60IMaC.js";import"./chevron-right-oiH9IUMb.js";import"./index-CYVXVt0p.js";import"./loader-circle-DVzH7cLw.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
