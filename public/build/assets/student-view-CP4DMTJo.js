import{c as H,r as M,j as e,H as P}from"./app-C18Sz5h1.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-BNJ1JXDF.js";import{B as U}from"./button-BqScBw3n.js";import{G as $}from"./GurukulReportCard-MS2Tz1xX.js";import{A as z}from"./award-FXzU9l6R.js";import{F as G}from"./file-text-CYMom-vp.js";import{P as D}from"./printer-CHKSiyrM.js";import"./app-CY4rgINh.js";import"./breadcrumb-MwovxL_K.js";import"./chevron-right-VcDRKGh8.js";import"./index-pBRwZQGN.js";import"./loader-circle-BHDq2MCu.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
