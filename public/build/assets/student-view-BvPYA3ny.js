import{c as H,r as M,j as e,H as P}from"./app-84S78huI.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-mrQ4MaW2.js";import{B as U}from"./button-CJTORmkL.js";import{G as $}from"./GurukulReportCard-DyNxgkz0.js";import{A as z}from"./award-CVq-1MsN.js";import{F as G}from"./file-text-D_ZGgzHN.js";import{P as D}from"./printer-xgVOmtdU.js";import"./app-BlCzN3Vk.js";import"./breadcrumb-Dl3YgvFU.js";import"./chevron-right-Dla_PT_5.js";import"./index-k1T6U8RV.js";import"./loader-circle-CPBIP1YX.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
