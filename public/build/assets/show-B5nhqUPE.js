import{c as z,r as G,j as e,H as I}from"./app-DX-111SG.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-AK2aNXwh.js";import{B as Y}from"./button-A3Ihw45a.js";import{G as D}from"./GurukulReportCard-Bjv6YRqM.js";import{A as J}from"./award-DfhUBOOh.js";import{F as K}from"./file-text-DoiFxhlX.js";import{P as V}from"./printer-CUXshhL_.js";import"./app-B7qWJiIz.js";import"./breadcrumb-BQ0av4Tq.js";import"./chevron-right-BjAGfp7z.js";import"./index-C_i3kHAN.js";import"./loader-circle-D_MESUNW.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
