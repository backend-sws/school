import{c as H,r as M,j as e,H as P}from"./app-Ccr8P44O.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-2oZkkWmw.js";import{B as U}from"./button-Bw1Xy9dz.js";import{G as $}from"./GurukulReportCard-B36oAx1B.js";import{A as z}from"./award-CGFXcboK.js";import{F as G}from"./file-text-nww2w09D.js";import{P as D}from"./printer-BkPRsld1.js";import"./app-B8MoKkf6.js";import"./breadcrumb-CiU6JB3v.js";import"./chevron-right-DRBSusEP.js";import"./index-BwNzEkz4.js";import"./loader-circle-B4v2CFLt.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
