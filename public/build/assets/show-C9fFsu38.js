import{c as z,r as G,j as e,H as I}from"./app-kBj0ul1V.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-CMJelBoO.js";import{B as Y}from"./button-D-DzAwGP.js";import{G as D}from"./GurukulReportCard-Bki9xMRa.js";import{A as J}from"./award-V6NkBU2y.js";import{F as K}from"./file-text-DYpZ6yLt.js";import{P as V}from"./printer-BQcMAhty.js";import"./app-Cshy28NO.js";import"./breadcrumb-B46qB36S.js";import"./chevron-right-DluGBAGi.js";import"./index-uOcz-REP.js";import"./loader-circle-CZPiUHiN.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
