import{c as H,r as M,j as e,H as P}from"./app-BTJ-XKva.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-iH1OSA-A.js";import{B as U}from"./button-BqFnQN07.js";import{G as $}from"./GurukulReportCard-CpQVcJbs.js";import{A as z}from"./award-Y3tEQqbN.js";import{F as G}from"./file-text-Ch1JnOBN.js";import{P as D}from"./printer-BTVJs0Um.js";import"./app-Cank25iK.js";import"./breadcrumb-KkMKripD.js";import"./chevron-right-CLkR0SF9.js";import"./index-DyVHCU3Y.js";import"./loader-circle-CgPIoltB.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
