import{c as z,r as G,j as e,H as I}from"./app-BJ09nUjR.js";import{E as U}from"./breadcrumbs-CxqP3Ty0.js";import{M as L}from"./MainPageHeader-DtaOXN-z.js";import{B as Y}from"./button-BdS_B1Cd.js";import{G as D}from"./GurukulReportCard-CCNWxSpJ.js";import{A as J}from"./award-BbgXeAck.js";import{F as K}from"./file-text-Dsek6dt3.js";import{P as V}from"./printer-g6gjGARd.js";import"./app-BAHbSmPN.js";import"./breadcrumb-JMXnLZY3.js";import"./chevron-right-CDYRmvcA.js";import"./index-MGwb6nJx.js";import"./loader-circle-BWl_Wk0A.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
