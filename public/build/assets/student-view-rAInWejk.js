import{c as H,r as M,j as e,H as P}from"./app-DX-111SG.js";import{S as F}from"./breadcrumbs-68cs4gBf.js";import{M as B}from"./MainPageHeader-AK2aNXwh.js";import{B as U}from"./button-A3Ihw45a.js";import{G as $}from"./GurukulReportCard-Bjv6YRqM.js";import{A as z}from"./award-DfhUBOOh.js";import{F as G}from"./file-text-DoiFxhlX.js";import{P as D}from"./printer-CUXshhL_.js";import"./app-B7qWJiIz.js";import"./breadcrumb-BQ0av4Tq.js";import"./chevron-right-BjAGfp7z.js";import"./index-C_i3kHAN.js";import"./loader-circle-D_MESUNW.js";function nt(S){const t=H.c(35),{marksheet:w,exam:c,student:f,reportCardInstitution:C,institution:T}=S,[n,E]=M.useState("final");f?.name||f?.user?.name;const _=C||T,v=`Annual Report Card: ${c?.name||"Exam"}`;let r;t[0]!==v?(r=e.jsx(P,{title:v}),t[0]=v,t[1]=r):r=t[1];let u;t[2]===Symbol.for("react.memo_cache_sentinel")?(u=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
