import{c as z,r as G,j as e,H as I}from"./app-DjcrZXpY.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-DW2VfvVz.js";import{B as Y}from"./button-Vbm9mg42.js";import{G as D}from"./GurukulReportCard-DT26GvFf.js";import{A as J}from"./award-DlbUVo9R.js";import{F as K}from"./file-text-CNLk7pGI.js";import{P as V}from"./printer-BFO13CQL.js";import"./app-BDvIfzgH.js";import"./breadcrumb-BljlVKFY.js";import"./chevron-right-CcVCJnIO.js";import"./index-CnjWvy8Q.js";import"./loader-circle-BsMGkwA6.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
