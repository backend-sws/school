import{c as z,r as G,j as e,H as I}from"./app-84S78huI.js";import{E as U}from"./breadcrumbs-68cs4gBf.js";import{M as L}from"./MainPageHeader-mrQ4MaW2.js";import{B as Y}from"./button-CJTORmkL.js";import{G as D}from"./GurukulReportCard-DyNxgkz0.js";import{A as J}from"./award-CVq-1MsN.js";import{F as K}from"./file-text-D_ZGgzHN.js";import{P as V}from"./printer-xgVOmtdU.js";import"./app-BlCzN3Vk.js";import"./breadcrumb-Dl3YgvFU.js";import"./chevron-right-Dla_PT_5.js";import"./index-k1T6U8RV.js";import"./loader-circle-CPBIP1YX.js";function lt(T){const t=z.c(42),{marksheet:v,exam:n,student:u,reportCardInstitution:F,institution:B}=T,[a,H]=G.useState("final"),P=u?.name||u?.user?.name||"RAJVEER KUMAR GUPTA",k=F||B,R=`Report Card: ${P} - ${n?.name||"Exam"}`;let r;t[0]!==R?(r=e.jsx(I,{title:R}),t[0]=R,t[1]=r):r=t[1];let h;t[2]===Symbol.for("react.memo_cache_sentinel")?(h=e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @page {
          size: A4 portrait;
          margin: 4mm 6mm;
        }
