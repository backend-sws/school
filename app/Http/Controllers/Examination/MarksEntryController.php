...
class MarksEntryController extends Controller
{
    ...
    public function saveBatch(Request $request, ExamSchedule $schedule)
    {
        $validated = $request->validate([
            ...
            'marks.*.fa1' => 'nullable|numeric|min:0',
            'marks.*.fa2' => 'nullable|numeric|min:0',
            'marks.*.sa1' => 'nullable|numeric|min:0',
            'marks.*.fa3' => 'nullable|numeric|min:0',
            'marks.*.fa4' => 'nullable|numeric|min:0',
            'marks.*.sa2' => 'nullable|numeric|min:0',
        ...
        foreach ($validated['marks'] as $markData) {
            ExamMark::updateOrCreate(
                ...
                [
                    ...
                    'fa1' => $markData['is_absent'] ? null : $markData['fa1'],
                    'fa2' => $markData['is_absent'] ? null : $markData['fa2'],
                    'sa1' => $markData['is_absent'] ? null : $markData['sa1'],
                    'fa3' => $markData['is_absent'] ? null : $markData['fa3'],
                    'fa4' => $markData['is_absent'] ? null : $markData['fa4'],
                    'sa2' => $markData['is_absent'] ? null : $markData['sa2'],
