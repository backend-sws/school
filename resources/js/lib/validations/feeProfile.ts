...
export const feeProfileSchema = z.object({
    ...
    session_id: z.union([z.coerce.number(), z.string()]).optional().nullable(),
...
/** Input type for useForm — fee_type_id and amount can be string or number */
export type FeeProfileFormInputValues = Omit<FeeProfileFormData, "items" | "session_id"> & {
    session_id?: string | number | null;
    items: { fee_type_id: string | number; amount: string | number }[];
};
