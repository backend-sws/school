 ...
 */
export const show = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
show.url = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
show.get = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
show.head = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
    const showForm = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
        showForm.get = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/examination/exams/{exam}/marksheet/{student}'
 */
        showForm.head = (args: { exam: number | { id: number }, student: string | number | { id: string | number } } | [exam: number | { id: number }, student: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
