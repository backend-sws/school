...
/**
* @see \App\Http\Controllers\Api\V1\Organization\OrganizationController::institutions
...
institutions.definition = {
    methods: ["get","head"],
    url: '/api/v1/organizations/{organization}/institutions',
...
institutions.url = (args: { organization: string | number | { id: string | number } } | [organization: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    ...
    return institutions.definition.url
...
const OrganizationController = { institutions, index, store, show, update, destroy }
