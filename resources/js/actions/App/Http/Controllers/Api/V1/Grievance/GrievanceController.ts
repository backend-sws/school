 ...
 * @see app/Http/Controllers/Api/V1/Grievance/GrievanceController.php:144
 ...
 * @route '/api/v1/public/grievances'
 */
    const publicStoreForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: publicStore.url(options),
        method: 'post',
    })
 ...
 * @route '/api/v1/public/grievances'
 */
        publicStoreForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: publicStore.url(options),
            method: 'post',
        })
    
    publicStore.form = publicStoreForm
/**
 ...
 * @see app/Http/Controllers/Api/V1/Grievance/GrievanceController.php:185
 ...
 * @see app/Http/Controllers/Api/V1/Grievance/GrievanceController.php:201
 * @route '/api/v1/grievances/{grievance}'
 */
 ...
 * @see app/Http/Controllers/Api/V1/Grievance/GrievanceController.php:255
 * @route '/api/v1/grievances/{grievance}'
 */
 ...
 * @see app/Http/Controllers/Api/V1/Grievance/GrievanceController.php:229
