...
/**
* @see \App\Http\Controllers\Api\V1\Transport\TransportVehicleController::exportMethod
 * @see app/Http/Controllers/Api/V1/Transport/TransportVehicleController.php:132
 * @route '/api/v1/transport/vehicles/export'
 */
...
exportMethod.definition = {
    methods: ["get","head"],
    url: '/api/v1/transport/vehicles/export',
...
const TransportVehicleController = { exportMethod, index, store, show, update, destroy, export: exportMethod }
