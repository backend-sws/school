 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:497
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:667
...
exportExcel.definition = {
    methods: ["get","head"],
    url: '/api/v1/fees/ledger/student/{studentId}/export',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:133
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:523
 * @route '/api/v1/fees/ledger/collect-advance'
 */
export const collectAdvance = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: collectAdvance.url(options),
    method: 'post',
})

collectAdvance.definition = {
    methods: ["post"],
    url: '/api/v1/fees/ledger/collect-advance',
} satisfies RouteDefinition<["post"]>
...
collectAdvance.url = (options?: RouteQueryOptions) => {
    return collectAdvance.definition.url + queryParams(options)
}
 ...
 */
    const collectAdvanceForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: collectAdvance.url(options),
        method: 'post',
    })
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:290
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:407
 ...
 * @see app/Http/Controllers/Api/V1/Fees/StudentLedgerController.php:327
 * @route '/api/v1/fees/ledger/revert-payment'
 */
export const revertPayment = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: revertPayment.url(options),
    method: 'post',
})

revertPayment.definition = {
    methods: ["post"],
    url: '/api/v1/fees/ledger/revert-payment',
} satisfies RouteDefinition<["post"]>
...
revertPayment.url = (options?: RouteQueryOptions) => {
    return revertPayment.definition.url + queryParams(options)
}
 ...
 */
    const revertPaymentForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: revertPayment.url(options),
        method: 'post',
    })
 ...
 */
    ...
    revertPayment.form = revertPaymentForm
const StudentLedgerController = { downloadReceipt, exportExcel, getMatrix, collect, collectAdvance, resendReceipt, markAsPaid, revertPayment }
