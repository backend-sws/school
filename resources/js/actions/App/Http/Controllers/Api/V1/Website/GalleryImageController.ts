 ...
 * @route '/api/v1/website/gallery-images/sort'
 */
    const updateSortingForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: updateSorting.url({
 ...
 * @route '/api/v1/website/gallery-images/sort'
 */
        updateSortingForm.patch = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateSorting.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    updateSorting.form = updateSortingForm
/**
 ...
 * @route '/api/v1/website/galleries/{gallery}/images'
 */
    const indexForm = (args: { gallery: string | number } | [gallery: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/website/galleries/{gallery}/images'
 */
        indexForm.get = (args: { gallery: string | number } | [gallery: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: index.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/website/galleries/{gallery}/images'
 */
        indexForm.head = (args: { gallery: string | number } | [gallery: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/website/galleries/{gallery}/images'
 */
    const storeForm = (args: { gallery: string | number } | [gallery: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/website/galleries/{gallery}/images'
 */
        storeForm.post = (args: { gallery: string | number } | [gallery: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: store.url(args, options),
            method: 'post',
        })
