 ...
 * @route '/api/v1/notifications/channels/{type}'
 */
    const channelsForm = (args: { type: string | number } | [type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: channels.url(args, options),
        method: 'get',
    })
 ...
 * @route '/api/v1/notifications/channels/{type}'
 */
        channelsForm.get = (args: { type: string | number } | [type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: channels.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/notifications/channels/{type}'
 */
        channelsForm.head = (args: { type: string | number } | [type: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: channels.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
