...
show.url = (args: { fee_payment: string | number | { id: string | number } } | [fee_payment: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
                        fee_payment: typeof args.fee_payment === 'object'
                ? args.fee_payment.id
                : args.fee_payment,
                }
 ...
 * @route '/api/v1/fee-payments/{payment}/collect'
 */
    const collectForm = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/fee-payments/{payment}/collect'
 */
        collectForm.post = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: collect.url(args, options),
            method: 'post',
        })
