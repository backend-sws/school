...
/**
* @see \App\Http\Controllers\Api\V1\HR\LeaveRequestController::updateStatus
...
updateStatus.definition = {
    methods: ["patch"],
    url: '/api/v1/hr/leave-requests/{leaveRequest}/status',
...
const LeaveRequestController = { index, store, update, updateStatus }
