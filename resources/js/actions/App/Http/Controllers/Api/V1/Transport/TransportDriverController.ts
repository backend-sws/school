 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
    const showForm = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
        showForm.get = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
        showForm.head = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
    const updateForm = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
        updateForm.put = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
        updateForm.patch = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
    const destroyForm = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/transport/drivers/{transport_driver}'
 */
        destroyForm.delete = (args: { transport_driver: number | { id: number } } | [transport_driver: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
