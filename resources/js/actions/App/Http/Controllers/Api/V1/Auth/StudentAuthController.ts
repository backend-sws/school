 ...
 * @route '/api/v1/student-auth/find-application'
 */
    const findApplicationForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: findApplication.url(options),
        method: 'post',
    })
 ...
 * @route '/api/v1/student-auth/find-application'
 */
        findApplicationForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: findApplication.url(options),
            method: 'post',
        })
    
    findApplication.form = findApplicationForm
/**
