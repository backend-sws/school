 ...
 * @see app/Http/Controllers/Api/V1/Hostel/HostelMessPlanController.php:39
 * @route '/api/v1/hostel/mess-plans'
 */
 ...
 * @see app/Http/Controllers/Api/V1/Hostel/HostelMessPlanController.php:62
 ...
 * @see app/Http/Controllers/Api/V1/Hostel/HostelMessPlanController.php:71
 * @route '/api/v1/hostel/mess-plans/{hostel_mess_plan}'
 */
 ...
 * @see app/Http/Controllers/Api/V1/Hostel/HostelMessPlanController.php:91
 * @route '/api/v1/hostel/mess-plans/{hostel_mess_plan}'
 */
...
const HostelMessPlanController = { index, store, show, update, destroy }
