 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
    const showForm = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
        showForm.get = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
        showForm.head = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
    const updateForm = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
        updateForm.put = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
        updateForm.patch = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
    const destroyForm = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/expense-categories/{expense_category}'
 */
        destroyForm.delete = (args: { expense_category: string | number | { id: string | number } } | [expense_category: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
