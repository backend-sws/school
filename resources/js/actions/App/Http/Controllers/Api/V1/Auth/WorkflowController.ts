 ...
 */
export const syncPermissions = (args: { workflow: string | number | { id: string | number } } | [workflow: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
syncPermissions.url = (args: { workflow: string | number | { id: string | number } } | [workflow: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { workflow: args }
    }
 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
syncPermissions.post = (args: { workflow: string | number | { id: string | number } } | [workflow: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncPermissions.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
    const syncPermissionsForm = (args: { workflow: string | number | { id: string | number } } | [workflow: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
        syncPermissionsForm.post = (args: { workflow: string | number | { id: string | number } } | [workflow: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: syncPermissions.url(args, options),
            method: 'post',
        })
