 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
    const syncPermissionsForm = (args: { workflow: number | { id: number } } | [workflow: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/workflows/{workflow}/permissions'
 */
        syncPermissionsForm.post = (args: { workflow: number | { id: number } } | [workflow: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: syncPermissions.url(args, options),
            method: 'post',
        })
