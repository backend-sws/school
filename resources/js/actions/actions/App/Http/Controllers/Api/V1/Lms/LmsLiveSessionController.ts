...
/**
* @see \App\Http\Controllers\Api\V1\Lms\LmsLiveSessionController::index
* @see app/Http/Controllers/Api/V1/Lms/LmsLiveSessionController.php:17
* @route '/api/v1/lms/classes/{lms_class_id}/live-sessions'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/api/v1/lms/classes/{lms_class_id}/live-sessions',
...
/**
* @see \App\Http\Controllers\Api\V1\Lms\LmsLiveSessionController::store
* @see app/Http/Controllers/Api/V1/Lms/LmsLiveSessionController.php:40
* @route '/api/v1/lms/classes/{lms_class_id}/live-sessions'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\Lms\LmsLiveSessionController::show
* @see app/Http/Controllers/Api/V1/Lms/LmsLiveSessionController.php:83
* @route '/api/v1/lms/classes/{lms_class_id}/live-sessions/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/v1/lms/classes/{lms_class_id}/live-sessions/{id}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Api\V1\Lms\LmsLiveSessionController::update
* @see app/Http/Controllers/Api/V1/Lms/LmsLiveSessionController.php:97
* @route '/api/v1/lms/classes/{lms_class_id}/live-sessions/{id}'
*/
...
/**
* @see \App\Http\Controllers\Api\V1\Lms\LmsLiveSessionController::destroy
* @see app/Http/Controllers/Api/V1/Lms/LmsLiveSessionController.php:123
* @route '/api/v1/lms/classes/{lms_class_id}/live-sessions/{id}'
*/
...
const LmsLiveSessionController = { index, store, show, update, destroy }

export default LmsLiveSessionController