 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
    const showForm = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
        showForm.get = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
        showForm.head = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
    const updateForm = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
        updateForm.put = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
        updateForm.patch = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
    const destroyForm = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/subject-category-mappings/{subject_category_mapping}'
 */
        destroyForm.delete = (args: { subject_category_mapping: string | number } | [subject_category_mapping: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
export default subjectCategoryMappings