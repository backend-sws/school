 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
    const showForm = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
        showForm.get = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
        showForm.head = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
    const updateForm = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
        updateForm.put = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
        updateForm.patch = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
    const destroyForm = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/v1/website/tickers/{ticker}'
 */
        destroyForm.delete = (args: { ticker: number | { id: number } } | [ticker: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
