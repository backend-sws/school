...
return [
    ...
    'classes' => [
        'school' => [
            ['name' => 'Nursery - A',         'code' => 'NUR-A',      'main_stream' => 'Pre-Primary'],
            ['name' => 'LKG - A',             'code' => 'LKG-A',      'main_stream' => 'Pre-Primary'],
            ['name' => 'UKG - A',             'code' => 'UKG-A',      'main_stream' => 'Pre-Primary'],
            ['name' => 'Class I - A',         'code' => 'CLS-1-A',    'main_stream' => 'Primary'],
            ['name' => 'Class II - A',        'code' => 'CLS-2-A',    'main_stream' => 'Primary'],
            ['name' => 'Class III - A',       'code' => 'CLS-3-A',    'main_stream' => 'Primary'],
            ['name' => 'Class IV - A',        'code' => 'CLS-4-A',    'main_stream' => 'Primary'],
            ['name' => 'Class V - A',         'code' => 'CLS-5-A',    'main_stream' => 'Primary'],
            ['name' => 'Class VI - A',        'code' => 'CLS-6-A',    'main_stream' => 'Middle School'],
            ['name' => 'Class VII - A',       'code' => 'CLS-7-A',    'main_stream' => 'Middle School'],
            ['name' => 'Class VIII - A',      'code' => 'CLS-8-A',    'main_stream' => 'Middle School'],
            ['name' => 'Class IX - A',        'code' => 'CLS-9-A',    'main_stream' => 'Secondary'],
            ['name' => 'Class X - A',         'code' => 'CLS-10-A',   'main_stream' => 'Secondary'],
        ...
        'coaching' => [
            ['name' => 'Foundation Batch A', 'code' => 'FND-A', 'main_stream' => 'Foundation'],
            ['name' => 'Target Batch A',     'code' => 'TGT-A', 'main_stream' => 'Target'],
            ['name' => 'Crash Course A',     'code' => 'CC-A',  'main_stream' => 'Crash Course'],
        ],
        'university' => [
