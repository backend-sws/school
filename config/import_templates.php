...
return [
    ...
    'templates' => [
        ...
        'existing_students' => [
            'headings' => [
                ...
                'admission_fee_paid', 'admission_payment_date', 'admission_payment_mode', 'admission_receipt_no',
            ],
            'sample' => [
                ...
                '5000', '2025-04-10', 'cash', 'REC-2025-001',
            ],
        ],
    ],
    ...
    'validation_notes' => [
        ...
        'existing_students' => [
            ...
            ['admission_fee_paid (optional)', 'YES or amount (e.g. 5000) if collected (shows in Analytics); 0 / EXEMPT for old students; Leave blank to add to Previous Dues (Arrears)'],
            ['admission_payment_date (optional)', 'Date of payment (YYYY-MM-DD or MM/DD/YY). Defaults to admission date.'],
            ['admission_payment_mode (optional)', 'cash, online, upi, cheque, bank_transfer (default: cash)'],
            ['admission_receipt_no (optional)', 'Manual receipt number if available (auto-generated if blank)'],
            ['category', 'General, OBC, SC, ST, EWS'],
            ['religion', 'Hindu, Muslim, Christian, Sikh, Buddhist, Jain, Other'],
        ],
